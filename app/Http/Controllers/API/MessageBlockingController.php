...
class MessageBlockingController extends Controller
{
    public function blockedUsers(){
        ...
        // Patch: Remove "user" or "rest" instances from the collection if that's not the blocked_user_type
    ...
    public function blockUser(Request $request)
    {
        ...
        $blocked_user_type = $request->input('blocked_user_type', 'USER');
